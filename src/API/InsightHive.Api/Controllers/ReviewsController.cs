...
namespace InsightHive.Api.Controllers
{
    ...
    public class ReviewsController : ControllerBase
    {
        ...
        [HttpGet("{businessId}", Name = "GetBusinessReviews")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public async Task<ActionResult<BaseResponse<ReviewDto>>> Get(int businessId, int page = 1, int pageSize = 5, int maxComments = 0)
        {
